# DBMS_Project_ERP
A College ERP website for the DBMS Final Project. Its built using Django framework. It is designed for interactions between students and teachers. Features include attendance, marks and time table.
